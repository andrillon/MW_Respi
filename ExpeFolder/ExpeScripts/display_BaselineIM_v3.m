...
for nloop=1:2
    ...
    DrawFormattedText(w, sprintf('La séquence %g (sur 8) va commencer',(nloop-1)*4+1), 'center', 'center', [255 255 255]);
    tpSt=Screen('Flip',w);
...
%     end
    ...
    DrawFormattedText(w, sprintf('La séquence %g (sur 8) va commencer',(nloop-1)*4+2), 'center', 'center', [255 255 255]);
    tpSt=Screen('Flip',w);
    while GetSecs<tpSt+2
        [keyIsDown, secs, keyCode, deltaSecs] = KbCheck(-1);
        if keyIsDown==1
  ...
  if flag_escp
    ...
    DrawFormattedText(w, sprintf('La séquence %g (sur 8) va commencer',(nloop-1)*4+3), 'center', 'center', [255 255 255]);
    tpSt=Screen('Flip',w);
    while GetSecs<tpSt+2
        [keyIsDown, secs, keyCode, deltaSecs] = KbCheck(-1);
        if keyIsDown==1
    ...
    DrawFormattedText(w, sprintf('La séquence %g (sur 8) va commencer',(nloop-1)*4+4), 'center', 'center', [255 255 255]);
    tpSt=Screen('Flip',w);
    while GetSecs<tpSt+2
        [keyIsDown, secs, keyCode, deltaSecs] = KbCheck(-1);
        if keyIsDown==1
