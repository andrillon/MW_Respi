...
if flag_Tobii
    talk2tobii('EVENT','', 0.001, 'block', nblock);
end
%% play SART
if this_blockcond==1 % faces
    ...
    if flag_Tobii
        talk2tobii('EVENT','', 0.001, 'block', nblock, 'trial',ntrial);
    end
    ...
    while this_probe_count<number_probes
        ...
        if GetSecs>stimonset+dur_face_presentation % update face identity
            ...
            test_res=[test_res; [nblock this_blockcond thiset ntrial this_seq_trial TargetID thisresp stimonset thisresptime  this_nogo this_go]];
            thisresp=NaN;
...
if flag_Tobii
    talk2tobii('EVENT','', 0.001, 'block', 0);
end
WaitSecs(3);
