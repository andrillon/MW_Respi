...
supervised_questions = {...
    ...
    'Avez-vous volontairement contrôlé\nsur quoi se portait votre attention ?\n\n Complètement : Tapez 1\n\n - Légèrement : Tapez 2\n\n - Pas du tout : Tapez 3\n\n - Je ne sais plus : Tapez 4',...
    ...
    'A quel point vos pensées étaient-elles prenantes ?\n\n Très prenante : Tapez 1\n\n - Assez prenante : Tapez 2\n\n - Peu prenantes : Tapez 3\n\n - Pas du tout prenantes : Tapez 4',...
    'Comment jugeriez-vous votre performance ?\n\nTrès mauvaise : Tapez 1\n\n - Plutôt mauvaise : Tapez 2\n\n - Plutôt bonne : Tapez 3\n\n - Très bonne : Tapez 4',...
